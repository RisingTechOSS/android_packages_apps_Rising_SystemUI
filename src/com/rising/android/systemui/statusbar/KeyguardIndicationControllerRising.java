package com.rising.android.systemui.statusbar;
...
import com.rising.android.systemui.adaptivecharging.AdaptiveChargingManager;
...
@SysUISingleton
public class KeyguardIndicationControllerRising extends KeyguardIndicationController {
    ...
    private RisingKeyguardCallback mUpdateMonitorCallback;

    private class RisingKeyguardCallback extends KeyguardIndicationController.BaseKeyguardCallback {
        private RisingKeyguardCallback() {
            super();
        }
    ...
    @Inject
    public KeyguardIndicationControllerRising(
            Context context,
    ...
    public final KeyguardUpdateMonitorCallback getKeyguardCallback() {
        if (mUpdateMonitorCallback == null) {
            mUpdateMonitorCallback = new RisingKeyguardCallback();
        }
