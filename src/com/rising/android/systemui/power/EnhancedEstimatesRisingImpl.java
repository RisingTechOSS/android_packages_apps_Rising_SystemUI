...
package com.rising.android.systemui.power;
...
@SysUISingleton
public class EnhancedEstimatesRisingImpl implements EnhancedEstimates {

    private static final String TAG = "EnhancedEstimatesRisingImpl";

    private Context mContext;
    private final KeyValueListParser mParser = new KeyValueListParser(',');

    @Inject
    public EnhancedEstimatesRisingImpl(Context context) {
        mContext = context;
    }
