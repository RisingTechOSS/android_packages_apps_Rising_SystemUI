...
import com.rising.android.systemui.screenrecord.RisingRecordingService;
 ...
 */
@Module
public abstract class RisingServiceBinder {
    /** */
    @Binds
    @IntoMap
    ...
    public abstract Service bindRecordingService(RisingRecordingService service);
}
