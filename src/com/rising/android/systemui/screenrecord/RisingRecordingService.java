...
package com.rising.android.systemui.screenrecord;
...
public class RisingRecordingService extends RecordingService {
    ...
    private static final String TAG = "RisingRecordingService";

    private final NotificationManager mNotificationManager;
    private final UserContextProvider mUserContextTracker;

    @Inject
    public RisingRecordingService(RecordingController controller, @LongRunning Executor executor,
